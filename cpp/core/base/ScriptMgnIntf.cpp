...
void TVPExecuteStorage(const ttstr &name, iTJSDispatch2 *context,
    ...
    // Diagnostic: track key script loading
    {
        ...
        // Log all script loads that contain GFX, motion, flip, or .ks
        if(sn.find("GFX") != std::string::npos ||
           sn.find("gfx") != std::string::npos ||
           sn.find("motion") != std::string::npos ||
           sn.find("Motion") != std::string::npos ||
           sn.find("Flip") != std::string::npos ||
           sn.find("flip") != std::string::npos ||
           sn.find("custom") != std::string::npos ||
